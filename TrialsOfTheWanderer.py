...
def questBegin():
    ...
    print("")
    print("You must move forward,", playerData["PlayerName"] + ", for there")
    print("is a thing you must do. Though you do not know what it is, you can ")
    print("sense it, beckoning you forward...")
    print("")
    gameLoop()
